...
async function fetchEvents() {
    try {
        const response = await fetch('https://intern-hacks.vercel.app/Eventsubmit/getevents');
        if (!response.ok) {
...
async function deleteEvent(eventId) {
    try {
        const response = await fetch(`https://intern-hacks.vercel.app/Eventsubmit/deleteEvent/${eventId}`, {
            method: 'DELETE'
        });
        if (!response.ok) {
